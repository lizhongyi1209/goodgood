...
const CONFIG_CONTRACT_FILES = [
  ...
  "compose.production.account-deletion.yaml",
  ...
  "infra/production/CONTROLLED_ALPHA_RUNBOOK.md",
  ...
  "infra/production/account-deletion-cycle.sh",
  ...
  "scripts/verify-controlled-alpha-readiness.mjs",
  ...
  "server/account-deletion/runtime-config.mjs",
  "server/account-deletion/runtime-resources.mjs",
  "server/runtime/account-deletion-cycle.mjs",
