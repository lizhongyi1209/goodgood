...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-086 | JCOIN发行进度与自动刷新 | 实现中；只读UI，发行规则不变，未部署 | [任务](tasks/GG-086-jcoin-live-progress.md) |
...
GG-024—GG-086 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-087** 分配并检查是否已被占用。每次 alpha 发布仍须取得
