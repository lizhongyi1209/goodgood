...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-051 | 重新评估积分定价体系 | 下一阶段已登记，待用户在新窗口启动；尚未评估/实施，不调整现价或发布 | [任务](tasks/GG-051-credit-pricing-reassessment.md) |
...
GG-024—GG-051 已由任务占用（GG-047 为另一工作树的 agent 范围配置；GG-051 待新窗口启动）；下一个普通产品需求从 **GG-052** 分配并检查是否已被占用。每次 alpha 发布仍须取得
