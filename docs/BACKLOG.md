...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-087 | 私有问题反馈与站长处理 | 实现验证完成；522/25、SQL/UI通过，原预览更新中；未部署 | [任务](tasks/GG-087-problem-feedback.md) |
...
GG-024—GG-087 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-088** 分配并检查是否已被占用。每次 alpha 发布仍须取得新鲜、精确绑定候选的证据并通过门禁；本次证据不能复用。
