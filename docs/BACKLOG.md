...
最后同步：2026-09-10。这里是索引，细节以任务卡为准；不是自动执行所有项目的授权。
...
| GG-029 | 自建邮箱验证码登录，Google 延后 | P0 两封 QQ/一封 Gmail 真信成功，P1/P2 最小本地候选完成；发布前扩展矩阵与 P3/P4 待完成，未部署 | [任务](tasks/GG-029-email-otp-plan.md) / [方案](EMAIL_AUTH_PLAN.md) |
