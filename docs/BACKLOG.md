...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-051 | 重新评估积分定价体系与站长定价面板 | 人民币锚定 Runway 计价方向获认可，ADR 0062；1 元/100 积分等值分析完成，具体单位/费率待定，未实施/发布 | [任务](tasks/GG-051-credit-pricing-reassessment.md) |
...
GG-024—GG-051 已由任务占用（GG-047 为另一工作树的 agent 范围配置；GG-051 已启动评估）；下一个普通产品需求从 **GG-052** 分配并检查是否已被占用。每次 alpha 发布仍须取得
