...
最后同步：2026-09-11。这里是索引，细节以任务卡为准；不是自动执行所有项目的授权。
...
| GG-029 | 自建邮箱验证码登录，Google 延后 | P0 真信/真实应用登录闭环及 P1/P2/P3 本地代码完成；登录视觉已按规范收敛；发布前外部证据、生产演练与 P4 待完成，未部署 | [任务](tasks/GG-029-email-otp-plan.md) / [方案](EMAIL_AUTH_PLAN.md) |
