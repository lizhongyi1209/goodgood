...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-080 | JCOIN 分发规划与管理统计口径 | 规划完成待讨论；精确接续 a73835f，文档15/15与试算通过，未发币/改看板/部署 | [任务](tasks/GG-080-jcoin-planning.md) |
...
GG-024—GG-071 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-080** 分配并检查是否已被占用。每次 alpha 发布仍须取得
