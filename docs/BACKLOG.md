...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-088 | 问题类型下拉向下展开 | 实现待验证；未部署 | [任务](tasks/GG-088-feedback-select-downward.md) |
...
GG-024—GG-088 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-089** 分配并检查是否已被占用。每次 alpha 发布仍须取得新鲜、精确绑定候选的证据并通过门禁；本次证据不能复用。完整发布证据见[累计发布记录](releases/2026-09-09-cumulative-alpha-release.md)。
## 已明确搁置（不得自动恢复）
| ID | 事项 | 恢复条件 | 入口 |
| --- | --- | --- | --- |
