...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-083 | JCOIN分批定额与仅累计 | 第一期100万枚/预计50万元消费→每100有效积分2枚已定；执行规则待确定，不兑换或锚定人民币，未实施/发币 | [任务](tasks/GG-083-jcoin-batch-accumulation.md) |
...
GG-024—GG-083 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-084** 分配并检查是否已被占用。每次 alpha 发布仍须取得
