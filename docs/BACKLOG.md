...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-082 | JCOIN最小发行、用途与倍率讨论 | 仅充值消费挖矿可独立一期；缺发行账本，首期额度/倍率/兑换均建议待确认，未实施/发币 | [任务](tasks/GG-082-jcoin-minimum-issuance.md) |
...
GG-024—GG-082 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-083** 分配并检查是否已被占用。每次 alpha 发布仍须取得
