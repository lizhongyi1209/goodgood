...
| ID | 事项 | 状态 | 入口 |
| --- | --- | --- | --- |
| GG-084 | JCOIN账本、个人统计与站长计划 | 本地完成；门禁515/24、隔离SQL1/1与桌面窄屏通过；未部署/真实发行 | [任务](tasks/GG-084-jcoin-ledger-pages.md) |
...
GG-024—GG-084 已由任务占用（GG-047 为另一工作树的 agent 范围配置）；下一个普通产品需求从 **GG-085** 分配并检查是否已被占用。每次 alpha 发布仍须取得
