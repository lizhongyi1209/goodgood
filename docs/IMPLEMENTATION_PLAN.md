...
- Current objective: GG-027 在 GG-026 本地整合候选上分阶段实现企业/分销直属下级积分划拨；
  阶段 0—2 已完成决策契约、充值来源守恒、业务身份和直属关系，下一步做原子零和划拨。所有工作留在本地，
  当前线上 `65ceb168` 保持不变。
...
- Next action: 实现 GG-027 阶段 3 的直属下级查询、充值来源积分原子零和划拨、公开编号和活动投影。
...
| GG-027 | 阶段 0—2 已完成 | 分销边界、充值来源守恒、业务身份与直属关系已验证；阶段 3 待实现 |
