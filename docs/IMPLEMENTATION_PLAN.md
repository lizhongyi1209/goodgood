...
- 同任务追问补五参考图/5000 文本 tokens 敏感性：Pro 五图输入增加 0.0392 元，加文本为 0.1092 元；Banana 2 以通用 high 每图 1120 tokens 假设增加 0.0196/0.0371 元，非模型已确认定额或上限。新表只含输入＋最终图片输出，间接思考另算，实际 usage 待校准。
