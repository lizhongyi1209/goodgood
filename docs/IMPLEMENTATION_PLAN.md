...
1. 读根 AGENTS.md、docs/CURRENT_STATE.md、docs/WORKFLOW.md、本页和 docs/BACKLOG.md，进入 `F:/goodgood-worktrees/GG-085`，读GG085/GG084任务/ADR0084及server/jcoin与features/jcoin，核验3f23285/a73835f祖先；继续当前代码/验证，不退旧版本。
