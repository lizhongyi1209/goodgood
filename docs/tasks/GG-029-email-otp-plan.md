...
- 状态：P0 服务、发信域、DNS、发信地址及香港主机 SMTP 认证冒烟已完成，等待真实收件验证；P1 本地候选完成、P2 界面/清理部分完成并验证；未部署
...
- 尚未完成：P0 真实收件与投递表现；P2 告警/支持汇总和定向账号撤销验收；P3 受审绑定工具、模式化 production preflight/生产 SMTP 密码轮换与秘密挂载/CI；P4 上线与观察。
...
- 下一步：取得明确授权的 QQ、163、Gmail、Outlook 测试收件箱后，按批准的地址和数量做真实验证码收件验证；在此之前不发送邮件。回复能力仍需站长提供真实支持邮箱。正式部署密码的重新设置与秘密挂载留在 P3 单独批准范围；不要切生产、清理 Authing 或继续 GG-028 域名修复。
