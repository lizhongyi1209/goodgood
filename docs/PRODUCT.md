...
JCOIN当前决定见[ADR0081](decisions/0081-jcoin-batch-accumulation.md)：每批限定总额、无截止日期、发完后另行开启下一批；第一期仅充值消费挖矿并累计，不支持积分或其他兑换，不锚定人民币价值。第一期100万枚已由[ADR0082](decisions/0082-jcoin-first-batch-budget.md)接受，奖励比例仍待确定；此前兑换/服务面值及自动跨阶段建议已失效。总上限1亿、5000万用户回馈、消费驱动与2026-09-18北京时间00:00起算不变，20%创作安排保留未启动。当前没有JCOIN运行时，见[GG083思路](research/GG-083-jcoin-batch-accumulation.md)。下文GG080为历史规划背景。
