...
GG-091替代GG090单次长码和表单切换：每账户固定唯一6位数字邀请码、可无限邀请，显示本人积分下方；单一邮箱/验证码/邀请码/确认表单，新用户与旧pending必须活动账户的邀请码，老active只邮箱验证。邀请码为分享标识，不授予角色或奖励；仅本地候选。线上测试账户清理已独立执行，见GG091任务。
